...
public class CANSpeedController extends AbstractTableWidget implements Controller {
     ...
     */
    private static final String[] talonModes = {"PercentVbus", "Position", "Speed", "Current", "Voltage", "Follower", "Disabled"};
    ...
    private ActionListener modeSelection = e -> {
        ...
        mode = m;
        table.putBoolean("Enabled", mode == 0 || mode == 4); // enable on %VBus and voltage, disable on all others
